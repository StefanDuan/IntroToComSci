...
def update_hand(hand, word):
    ...
    for letter in hand:
        left_num = hand[letter] - word_dict.get(letter,0)
        if left_num >= 1:
            new_hand[letter] = left_num
    return new_hand
...
def play_game(word_list):
    ...
    * If the user inputs anything else, ask them again.
    """
    # TO DO ...
    # test_hand1 = {'a':1, 'c':1, 'i':1, 'h':1, 'm':2, 'z':1}
    # test_hand2 = {'a':1, 's':1, 't':2, 'w':1, 'f':1, 'o':1}
    # play_hand(test_hand2, word_list)
